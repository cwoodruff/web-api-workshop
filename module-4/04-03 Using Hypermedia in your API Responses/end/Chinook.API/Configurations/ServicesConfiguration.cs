...
public static class ServicesConfiguration
{
    ...
    public static void AddHypermedia(this IServiceCollection services)
    {
        ...
        services.AddScoped<Chinook.Domain.Hypermedia.RepresentationEnricher>();

        // Register enrichers
        services.AddScoped<Chinook.Domain.Hypermedia.IEnricher, Chinook.API.Hypermedia.Enrichers.TrackEnricher>();
        services.AddScoped<Chinook.Domain.Hypermedia.IEnricher, Chinook.API.Hypermedia.Enrichers.TracksEnricher>();
        services.AddScoped<Chinook.Domain.Hypermedia.IEnricher, Chinook.API.Hypermedia.Enrichers.AlbumEnricher>();
        services.AddScoped<Chinook.Domain.Hypermedia.IEnricher, Chinook.API.Hypermedia.Enrichers.AlbumsEnricher>();
    }
}